...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h2 class="text-xl font-bold text-gray-900 dark:text-white">Edit Layanan Laundry</h2>
            <p class="text-sm text-gray-500 dark:text-gray-400">Ubah informasi layanan laundry: {{ $service->name }}.</p>
        </div>
    </div>
        ...
        <form method="POST" action="{{ route('services.update', $service) }}" class="space-y-6">
            ...
            <div class="flex items-center gap-3">
                <input type="checkbox" 
                       ...
                       id="is_active" 
                       value="1" 
                       @if(old('is_active', $service->is_active)) checked @endif
